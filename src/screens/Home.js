...
let projectList = [
  ...
  { clientName: 'Client', projectNumber: '1234567', status: 'sent', time: '3 hours ago' },
  { clientName: 'Client', projectNumber: '1234567', status: 'draft', time: '3 hours ago' },
  { clientName: 'Client', projectNumber: '1234567', status: 'sent', time: '3 hours ago' },
  { clientName: 'Client', projectNumber: '1234567', status: 'draft', time: '3 hours ago' },
  { clientName: 'Client', projectNumber: '1234567', status: 'sent', time: '3 hours ago' },
  { clientName: 'Client', projectNumber: '1234567', status: 'sent', time: '3 hours ago' },
        ...
        <View style={styles.rightContainer}>
          <View style={styles.topHeader}>
            <View style={{ flexDirection: 'row', alignItems: "center" }}>
              <Text text={'Projects'} bold={true} font={22} color={themeColor} />
              <TouchableOpacity style={styles.plusButton}>
                <Icon type={'antdesign'} name={"plus"} color={'#fff'} size={16} />
              </TouchableOpacity>
            </View>
            <SearchBar
              placeholder="Search"
