...
import {
    StyleSheet, View, Image, ScrollView, TouchableOpacity
} from 'react-native';
        ...
        <View style={{ flex: 1, flexDirection: "row" }} >
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{ flex: 1 }}>
                        <Text text={"Welcome back."} color={'#000'}
                            bold={true} font={25} />
                        <Input
                            label={"Email"}
                            placeholder={""}
                        ...
                        <Button
                            ...
                            buttonStyle={{ alignSelf: "flex-start", marginTop: 12, borderRadius: 25 }}
                        />
                        <View style={{
                            flexDirection: "row", justifyContent: 'space-between',
                            marginTop: 12, marginBottom: 41, alignItems: "center"
                        }}>
                            <CheckBox
                                title='Click Here'
                                checked={checked}
                            ...
                            />
                            <TouchableOpacity>
                                <Text color={'#D1D1D1'} text={'Forgot password?'} font={14} bold={true} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
